...
const Navbar = () => {
  ...
  const dropdownItems = [
    { label: 'New Customer', icon: <FaUserPlus className="text-teal-500" /> },
    { label: 'Sign Up', icon: <FaUser className="text-teal-500" /> },
    { label: 'Wishlist', icon: <FaHeart className="text-teal-500" /> },
    { label: 'Offers', icon: <FaTag className="text-teal-500" /> },
    { label: 'Cart', icon: <FaShoppingBag className="text-teal-500" /> },
    { label: 'Orders', icon: <FaBoxOpen className="text-teal-500" /> },
      ...
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-6">
          ...
          >
            ...
            <span className="absolute -top-2 -right-2 text-xs bg-red-500 text-white rounded-full px-1.5 select-none">
              2
            </span>
          </motion.button>
        </div>
            ...
            <ul className="space-y-2">
              {dropdownItems.map((item, index) => (
                <li
                  ...
                  className="flex items-center gap-3 text-gray-700 hover:text-teal-600 py-2 border-b"
                >
                  {item.icon}
                  {item.label}
                </li>
